...
Ref
Stürmischer Tag, stürmischer Jahr
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-start p-6 pt-24 sm:p-8 sm:pt-24 font-sans overflow-x-hidden bg-black text-white">
      ...
      <main className="relative z-10 flex w-full max-w-2xl flex-col items-center gap-12">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          <div className="relative h-48 w-48 overflow-hidden rounded-2xl border-4 border-white/20 shadow-2xl">
            <Image
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-black tracking-tighter uppercase italic">CARPE OMNIA</h1>
            <p className="text-lg text-zinc-400 font-bold uppercase tracking-widest italic">{t("lyrics_and_video")}</p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-8 w-full">
            ...
            {/* Lyrics Display Area */}
            <div className="w-full rounded-2xl border border-white/10 bg-white/5 p-8 text-center mb-12">
        ...
        <footer className="mt-auto text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 pb-8">
